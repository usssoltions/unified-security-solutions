  ...
  return (
    <>
      <Button
        ...
        className="w-full bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white shadow-lg shadow-red-500/50 py-6 text-lg font-bold animate-pulse"
      >
