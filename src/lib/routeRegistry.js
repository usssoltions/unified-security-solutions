...
export const ROUTE_REGISTRY = {
  ...
  customer_admin: [
    { title: "Dashboard", pageKey: "ClientDashboard", icon: BarChart3, isRoot: true },
    { title: "Sites", pageKey: "SiteManagement", icon: MapPin },
    { title: "Att. Workers", pageKey: "AttendanceWorkers", icon: Users },
    { title: "Att. Records", pageKey: "AttendanceRecords", icon: FileText },
    { title: "Att. Reports", pageKey: "AttendanceReports", icon: BarChart3 },
    { title: "Att. Settings", pageKey: "AttendanceSettings", icon: Sliders },
    { title: "User Management", pageKey: "UserManagement", icon: Users },
    { title: "Profile", pageKey: "Profile", icon: UserCircle },
  ],
  reseller_admin: [
