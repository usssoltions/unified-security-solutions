...
export default function Scheduling() {
  ...
  const handleDateSelect = (date) => {
    // Could open form with pre-selected date
  ...
  return (
    <div className="min-h-screen p-4 lg:p-6 space-y-6">
      ...
      {/* Tabs for view selection - properly wrapped */}
                ...
                {shifts.length === 0 ? (
                  ...
                  shifts.map((shift) => (
                    <div
                      ...
                      className="p-4 bg-slate-900/50 rounded-lg border border-slate-700 hover:border-sky-500/50 transition-colors cursor-pointer"
                    >
                      <div className="flex items-start justify-between">
                        ...
                        <Badge className={statusColors[shift.status] || statusColors.default}>
                          {shift.status}
                        </Badge>
                      </div>
                    </div>
